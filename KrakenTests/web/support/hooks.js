...
Before(async function() {
  ...
  this.paginaCrearModificarEliminarElemento = new PaginaCrearModificarEliminarElemento(this.driver);
  this.paginaListarEtiquetas = new PaginaListarEtiquetas(this.driver);
  this.paginaCrearModificarEliminarEtiqueta = new PaginaCrearModificarEliminarEtiqueta(this.driver);
