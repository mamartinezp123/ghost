...
3. Una vez se instalen las dependencias, puede ejecutar el comando npm __*index.js*__
4. Al terminar la ejecución, se verá la carpeta reportes generada en la raíz
5. Ingrese a la carpeta y abra el archivo html
