class PaginaListarElementos {
    ...
    driver;
    nuevoElementoBy = "css=.view-actions a";
    elementosTitulosBy = "css=.gh-posts-list-item .gh-content-entry-title";
    elementosEstadosBy = "css=.gh-posts-list-item .gh-content-status-published";
