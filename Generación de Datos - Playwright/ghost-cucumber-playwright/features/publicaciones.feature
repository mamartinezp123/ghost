Feature: Publicaciones
  ...
  Scenario Outline: Crear un draft con un titulo igual a 256 caracteres
    Given un usuario autenticado
    When hace click en el link publicaciones
    And hace click en el boton nuevo
    And crea un draft con titulo "<titulo>" y contenido "<contenido>"
  ...
  Scenario Outline: Crear un draft con un titulo igual a 254 caracteres
    Given un usuario autenticado
    When hace click en el link publicaciones
    And hace click en el boton nuevo
    And crea un draft con titulo "<titulo>" y contenido "<contenido>"
  ...
  Scenario Outline: Crear un draft con un titulo igual a 200 caracteres
    Given un usuario autenticado
    When hace click en el link publicaciones
    And hace click en el boton nuevo
    And crea un draft con titulo "<titulo>" y contenido "<contenido>"
  ...
  Scenario Outline: Crear un draft con un titulo igual a 300 caracteres
    Given un usuario autenticado
    When hace click en el link publicaciones
    And hace click en el boton nuevo
    And crea un draft con titulo "<titulo>" y contenido "<contenido>"
