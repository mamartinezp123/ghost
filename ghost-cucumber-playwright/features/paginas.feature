Feature: Paginas
  ...
  Scenario: Modificar pagina
    ...
    And diligencia con "Modificar pagina actualizado" y "Esta es la prueba de modificar una pagina en Ghost" y envia el formulario crear - modificar elemento
    And va a la pagina de paginas
  ...
  Scenario: Modificar pagina con titulo de 285 caracteres
    ...
    And va a la pagina de paginas
    And hace click en el elemento "Modificar pagina"
    And diligencia con "Modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pagina modificar pag" y "Esta es la prueba de modificar una pagina en Ghost" y envia el formulario crear - modificar elemento
