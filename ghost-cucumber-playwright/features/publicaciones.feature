Feature: Publicaciones
  ...
  Scenario: Modificar publicacion
    ...
    And diligencia con "Modificar publicacion actualizada" y "Esta es la prueba de modificar un publicacion en Ghost" y envia el formulario crear - modificar elemento
    And va a la pagina de publicaciones
  ...
  Scenario: Modificar publicacion con titulo de 285 caracteres
    ...
    And va a la pagina de publicaciones
    And hace click en el elemento "Modificar publicacion"
    And diligencia con "Modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion modificar publicacion" y "" y envia el formulario crear - modificar elemento
